...
STAGE_ACCEPTS_FIELDS: Dict[Stage, List[str]] = {
    ...
    Stage.REGISTERING_NAME:          ["patient_name", "first_name", "last_name", "date_of_birth", "gender", "phone"],
    Stage.REGISTERING_DOB:           ["date_of_birth", "patient_name", "first_name", "last_name", "gender", "phone"],
    Stage.REGISTERING_GENDER:        ["gender", "patient_name", "first_name", "last_name", "date_of_birth", "phone"],
    Stage.REGISTERING_PHONE:         ["phone", "patient_name", "first_name", "last_name", "date_of_birth", "gender"],
