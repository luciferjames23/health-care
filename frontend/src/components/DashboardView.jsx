        ...
        <div className="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-6">
          <div className="max-w-xl">
            ...
            <p className="text-sm text-slate-300 leading-relaxed">
              Access curated clinical analytics: hospital bed management, patient admissions, radiology diagnostics, and discharge workflow — all in real-time.
            </p>
          </div>
        ...
        <div className="glass-panel glass-panel-hover rounded-xl p-5 border border-slate-800 relative overflow-hidden">
          ...
          <div className="mt-3">
            <div className="text-2xl font-extrabold font-mono text-emerald-400 tracking-tight">
              {bedKpis.occupied_beds || 0} Beds
            </div>
            <p className="text-[11px] text-slate-400 mt-1 flex items-center gap-1">
              <CheckCircle2 className="w-3 h-3 text-emerald-400" />
              Active admitted inpatient census
            </p>
          </div>
        </div>
